...
const Footer = () => {
  return (
    <div id="footer">
      ...
      <p id="email"><span className="fa-solid fa-envelope"></span> walter.rodriguez.dev@gmail.com</p>
      <p id="country"> <span className="fa-solid fa-house"></span> Verano Brianza, Lombardia, Italia</p>
